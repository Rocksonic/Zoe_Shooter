...
{
    const string privateCode = "-zU3S0Pn4U6ieK-bWZKj3guVMQrTXqf06zKlcv5dXhfw";  //Key to Upload New Info
    const string publicCode = "6131886c8f40bb6e98c5e1e0";   //Key to download
    const string webURL = "http://dreamlo.com/lb/-zU3S0Pn4U6ieK-bWZKj3guVMQrTXqf06zKlcv5dXhfw"; //  Website the keys are for
